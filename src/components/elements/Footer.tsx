...
const Footer = () => {
    return (
        <footer className="bg-green-600 dark:bg-gray-800">
        <div className="max-w-screen-xl p-4 py-6 mx-auto lg:py-16 md:p-8 lg:p-10">
            <div className="text-center">
                <a href="#" className=" text-white flex items-center justify-center mb-5 text-2xl font-semibold text-gray-900 dark:text-white">
                    <img src="./images/logo.png" className="h-6 mr-3 sm:h-9" alt="Landwind Logo" />
                    Best Mediacl Technologies
                </a>
                <span className="block text-sm text-center text-white dark:text-gray-400">© 2022-2023 BMT. Fait avec <a href="https://pubmed.ncbi.nlm.nih.gov/" className="text-white hover:underline dark:text-purple-500">PubGET</a> 
                </span>
                <ul className="flex justify-center mt-5 space-x-5 text-white">
                    <li>
                        <a href="#" className="hover:text-gray-900 dark:hover:text-white dark:text-gray-400">
